...
#include "../slave00/ConsoleReader.h"
...
QT_MOC_LITERAL(1, 14, 12), // "textReceived"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "message"
QT_MOC_LITERAL(4, 36, 4) // "text"

    },
    "ConsoleReader\0textReceived\0\0message\0"
    "text"
};
...
void ConsoleReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ConsoleReader::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConsoleReader::textReceived)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ConsoleReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ConsoleReader.data,
      qt_meta_data_ConsoleReader,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void ConsoleReader::textReceived(QString _t1)
{
